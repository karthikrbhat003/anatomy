# Applied Anatomy & Biomechanics: Daily Learning Tracker

Welcome to your daily learning companion! This tracker is designed to guide you step-by-step through applied anatomy and movement mechanics. It starts with foundational biomechanics (focused on calisthenics alignment and yoga posture corrections) and later transitions into systemic organ systems.
...
## 🛠️ Instructions
1. **Navigate:** Click on any day's link to open its detailed lesson notes.
2. **Track:** Mark the status column as `Completed` (or update emoji) when you finish a lesson, do the movement drills, and pass the daily quiz.
3. **Execute:** Follow the desk-side/mat-side biomechanics drills in each lesson to build muscle-mind connection.
