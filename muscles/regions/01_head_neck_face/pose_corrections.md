# 💀 Head, Face & Neck: Pose Corrections & Movement Applications

This index maps the movement practices and postural corrections for the head, face, and neck musculature to their dedicated, centralized biomechanical guides.

---

## 📱 Postural Dysfunction: "Tech-Neck" / Forward Head Posture
Forward head posture involves the head translating anteriorly, adding heavy leverage load to the neck. 

*   **Overactive (Tight):** Sternocleidomastoid (SCM), Upper Trapezius, Levator Scapulae, Suboccipitals.
*   **Underactive (Weak):** Deep neck flexors (**Longus Colli** and **Longus Capitis**).
